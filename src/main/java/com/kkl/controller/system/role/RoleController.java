package com.kkl.controller.system.role;
...
public class RoleController extends BaseController {
    ...
    public String auth(@RequestParam String ROLE_ID, Model model) throws Exception {
        ...
        try {
            ...
            json = json.replaceAll("MENU_ID", "id").replaceAll("MENU_NAME", "name").replaceAll("subMenu", "nodes")
    ...
    public void orleButton(@RequestParam String ROLE_ID, @RequestParam String menuIds, @RequestParam String msg,
